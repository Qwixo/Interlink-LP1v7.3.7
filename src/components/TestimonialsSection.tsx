            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  />
                  <div>
                    <h3 className="font-bold text-[#064088]">Student 1</h3>
                    <p className="text-sm text-gray-600">Text 1</p>
                  </div>
                </div>
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  />
                  <div>
                    <h3 className="font-bold text-[#064088]">Student 2</h3>
                    <p className="text-sm text-gray-600">Text 2</p>
                  </div>
                </div>
                <p className="text-gray-700">This student had an amazing experience with INTERLINK's language programs.</p>
              </div>
